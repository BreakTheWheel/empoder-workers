...
module.exports = (sequelize, Sequelize) => {
  const MsInstitutionalHoldingsSummary = sequelize.define('MsInstitutionalHoldingsSummary', {
    id: {
    ...
    {
      tableName: 'ms_institutional_holdings_summary',
      timestamps: false,
      underscored: true,
    },
  )

  return MsInstitutionalHoldingsSummary
}
